...
public class DowellGrammar8Modified implements SampleGrammar{
    ...
    public DowellGrammar8Modified(boolean withNonCanonicalRules) {
        ...
        Grammar.Builder<PairOfChar> Gb = new Grammar.Builder<PairOfChar>("Dowell Eddy G8")
                //-----------line 1
                ...
                .addRule(T, T, ao, Pau, uc)
                .addRule(T, T, uo, Pua, ac)
                .addRule(T, T, go, Pgc, cc)
                .addRule(T, T, co, Pcg, gc)
                .addRule(T, T, uo, Pug, gc)
                .addRule(T, T, go, Pgu, uc)
                ...
                .addRule(N, T, ao, Pau, uc)
                .addRule(N, T, uo, Pua, ac)
                .addRule(N, T, go, Pgc, cc)
                .addRule(N, T, co, Pcg, gc)
                .addRule(N, T, uo, Pug, gc)
                .addRule(N, T, go, Pgu, uc);
        ...
        if (withNonCanonicalRules) {
            Gb
                    ...
                    .addRule(T, T, ao, Paa, ac)
                    .addRule(T, T, ao, Pac, cc)
                    .addRule(T, T, ao, Pag, gc)
                    .addRule(T, T, co, Pca, ac)
                    .addRule(T, T, co, Pcc, cc)
                    .addRule(T, T, co, Pcu, uc)
                    .addRule(T, T, go, Pga, ac)
                    .addRule(T, T, go, Pgg, gc)
                    .addRule(T, T, uo, Puc, cc)
                    .addRule(T, T, uo, Puu, uc)

                    .addRule(N, T, ao, Paa, ac)
                    .addRule(N, T, ao, Pac, cc)
                    .addRule(N, T, ao, Pag, gc)
                    .addRule(N, T, co, Pca, ac)
                    .addRule(N, T, co, Pcc, cc)
                    .addRule(N, T, co, Pcu, uc)
                    .addRule(N, T, go, Pga, ac)
                    .addRule(N, T, go, Pgg, gc)
                    .addRule(N, T, uo, Puc, cc)
                    .addRule(N, T, uo, Puu, uc)
