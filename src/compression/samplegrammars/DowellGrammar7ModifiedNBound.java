...
public class DowellGrammar7ModifiedNBound implements SampleGrammar{
    ...
    public DowellGrammar7ModifiedNBound(boolean withNonCanonicalRules) {
      ...
      //NON TERMINALS FOR NON CANONICAL RULES
        ...
        Grammar.Builder<PairOfChar> Gb = new Grammar.Builder<PairOfChar>("Dowell Eddy 7 Modified and Bound")
                //-----------line 1
...
/*
                ...
                .addRule(N, L, S)
*/
                .addRule(T, U, L)//REPLACED N WITH T TO MAINTAIN LEXICOGRAPHICAL ORDERINGS
                .addRule(T, M, U)
                .addRule(T, U)
                .addRule(T, L, S)
